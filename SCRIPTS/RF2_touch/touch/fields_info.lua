...
profilesAcroTrainerGain = { t="Acro Trainer gain", help="Acro Trainer gain. Acro trainer Mode is not self leveling but does limit the maximum pitch/roll angle. This determines how aggressively the helicopter tilts back to the maximum angle (if exceeded) while in Acro Trainer Mode" },
profilesAcroTrainerLimit = { t="Acro Trainer angle limit", help="Acro Trainer angle limit. Acro Trainer mode does not self level (like Angle or Horizon Modes); however, it does limit the maximum angle the helicopter will pitch/roll to" },
profilesAngleModeGain = { t="Angle Mode leveling gain", help="Angle Mode leveling gain. This determines how aggressively the helicopter tilts back to level while in Angle Mode" },
profilesAngleModeLimit = { t="Angle Mode maximum angle", help="Angle Mode maximum angle. Helicopter is limited to this angle when in Angle mode" },
profilesHorizonModeGain = { t="Horizon Mode leveling gain", help="Horizon Mode leveling gain. This determines how aggressively the helicopter tilts back to level while in Horizon Mode" },
