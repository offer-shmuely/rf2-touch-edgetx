...
PageFiles[#PageFiles + 1] = { title = "Filters",            t2 = "Filters",             per_profile=false, script = "filters.lua",           img="filters.png" }
PageFiles[#PageFiles + 1] = { title = "Accelerometer trim", t2 = "Tune Acc",            per_profile=false, script = "accelerometer.lua",     img="acc.png" }
