...
labels[#labels + 1] = { t = "First Stage (aggressive pull)",  x = x,          y = inc.y(lineSpacing) }
...
fields[#fields + 1] = { t = "Rescue level gain",     x = x + indent,          y = inc.y(lineSpacing), sp = x + sp, min = 5, max = 250,   vals = { 4 },                                           id="profilesRescueLevelGain" }
fields[#fields + 1] = { t = "Rescue flip gain",      x = x + indent,          y = inc.y(lineSpacing), sp = x + sp, min = 5, max = 250,   vals = { 3 },                                           id="profilesRescueFlipGain" }
fields[#fields + 1] = { t = "Rescue max rate",       x = x + indent,          y = inc.y(lineSpacing), sp = x + sp, min = 1, max = 1000,  vals = { 25,26 }, mult = 10,                            id="profilesRescueMaxRate" }
fields[#fields + 1] = { t = "Rescue max accel",      x = x + indent,          y = inc.y(lineSpacing), sp = x + sp, min = 1, max = 10000, vals = { 27,28 }, mult = 10,                            id="profilesRescueMaxAccel" }

labels[#labels + 1] = { t = "Second stage (soft climb)",x = x,                y = inc.y(lineSpacing) }
...
labels[#labels + 1] = { t = "Third stage (hover)",   x = x,                   y = inc.y(lineSpacing) }
...
fields[#fields + 1] = { t = "Exit time",             x = x + indent,          y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 250,   vals = { 8 }, scale = 10,                               id="profilesRescueExitTime" }
